...
DB만을 사용하여 처음으로 프로젝트를 하게되었습니다. 그렇기에 매순간 이해하려 노력하고 집중하여 팀원들을 따라가고자 했습니다. 정산/금융에 대한 지식이 부족하여, 주제와 관련하여 어떤 흐름으로 진행되는지 알기 위해자료들을 추가적으로 확인하려 했고, 회의 중 나왔던 내용들을 같이 살펴보았습니다.
